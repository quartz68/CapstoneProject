...
def update_calc_display():
    ...
    '''
    cur_number_image = format_image(create_text_overlay('./images/black_square.png', deck_state.calc_input + " lbs", font_path='IBMPlexMono-SemiBold.ttf', font_color='#ffffff', font_y_offset=3, font_size=24))
